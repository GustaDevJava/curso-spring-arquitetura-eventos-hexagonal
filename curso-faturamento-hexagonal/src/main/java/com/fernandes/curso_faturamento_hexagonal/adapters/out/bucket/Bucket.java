package com.fernandes.curso_faturamento_hexagonal.adapters.out.bucket;

import com.fernandes.curso_faturamento_hexagonal.adapters.out.bucket.file.BucketFileRepresentation;
import com.fernandes.curso_faturamento_hexagonal.config.props.MinioProps;
...
public class Bucket {
    ...
    public void upload(BucketFileRepresentation file) {
        try {
